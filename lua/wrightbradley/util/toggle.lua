...
---@class wrightbradley.Toggle.wrap: wrightbradley.Toggle
---@operator call:boolean

---@param toggle wrightbradley.Toggle
  ...
  set = function(state)
    if state then
      ...
      vim.api.nvim_create_autocmd("ExitPre", {
        once = true,
        group = vim.api.nvim_create_augroup("wrightbradley_restore_max_exit_pre", { clear = true }),
