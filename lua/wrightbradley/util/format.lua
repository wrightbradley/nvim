...
function M.health()
  ...
  local has_extra = vim.tbl_contains(Config.spec.modules, "wrightbradley.plugins.extras.lsp.none-ls")
  if has_plugin and not has_extra then
    Util.warn({
      ...
      "but you need to enable the `wrightbradley.plugins.extras.lsp.none-ls` extra,",
