...
opt.clipboard = vim.env.SSH_TTY and "unnamedplus" or "" -- Do not sync with system clipboard
...
opt.ttimeoutlen = 10 -- Fast terminal escape key sequences; avoids conflict with timeoutlen increase
opt.undofile = true
